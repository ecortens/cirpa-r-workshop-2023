...
## `tidyr` Changes in 1.0

The `tidyr` package has been updated to 1.0.
There is some new syntax around pivoting data: see [here](https://tidyr.tidyverse.org/articles/pivot.html).
